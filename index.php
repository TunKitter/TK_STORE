<?php
  ...
  for ($i=0; $i < count($data); $i++) { 
    $arr[$i] = substr(str_replace('/','',dec_product($data[$i][0])[0]),2) . '__' . $data[$i][0] ;
  }
  sort($arr);
?>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Something  text</p>
            <h3><span>This</span> Is <br />Something <span>Text</span></h3>
            <h4>draw am refused meet size carried unusual law flower lay wrong symbol log</h4>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            ...
            <p>New products are show here</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        for ($i=count($arr)-1; $i >= count($arr)-3; $i--) { 
          $temp_data = getCustomData('SELECT * FROM products WHERE prod_id = "'. substr($arr[$i],strpos($arr[$i],'__')+2) .'"');
          echo '<div class="col-lg-4 col-md-6">
          <div class="single-product">
            <div class="product-img">
              <img class="img-fluid w-100" style="max-height:300px"  src="img/product/__0'. $temp_data[0][0].'.'. json_decode(base64_decode($temp_data[0][3]))[0]  .'" alt="" />
              <div class="p_icon">
                <a href="./single-product.php?id_product='. $temp_data[0][0] .'">
                  <i class="ti-eye"></i>
                </a>
                <a href="#">
                  <i class="ti-heart"></i>
            ...
            <div class="product-btm">
              ...
              <div class="mt-3">
                <span class="mr-4">$'. $temp_data[0][4] .'</span>
                <del>$'. $temp_data[0][4] .'</del>
              </div>
            </div>
          </div>
        </div>';
  ...
  <section class="new_product_area section_gap_top section_gap_bottom_custom">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Top 5 Favourite Products</span></h2>
            <p>5 products common are bought at most</p>
          </div>
        </div>
      </div>
  ...
  <section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Recommend For You</span></h2>
            <p>I'll suggest some products that you could interest in</p>
          </div>
        </div>
      </div>

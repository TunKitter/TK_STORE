...
<div class="section-top-border">
				<h3 class="mb-30 title_color">Product Category Management <button class="btn btn-info float-right mr-5" data-toggle="modal" data-target="#myModal">Add Product Category</button><button style="background-color: #f67590;" class="btn float-right mr-5 text-white btn-delete" disabled data-toggle="modal" data-target="#myModal" onclick="delete_customer()">Delete</button></h3>
